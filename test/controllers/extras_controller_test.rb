...
class ExtrasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create extra" do
    assert_difference('Extra.count') do
      post extras_url, params: { extra: { cost: @extra.cost, worker_id: @extra.worker_id, workshop_id: @extra.workshop_id } }
    end
  ...
  test "should update extra" do
    patch extra_url(@extra), params: { extra: { cost: @extra.cost, worker_id: @extra.worker_id, workshop_id: @extra.workshop_id } }
